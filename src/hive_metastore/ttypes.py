            ...
            if fid == 1:
                if ftype == TType.SET:
                    ...
                    for _i743 in range(_size739):
                        _elem744 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i791 in range(_size787):
                        _elem792 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
